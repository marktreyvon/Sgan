...
# try:
#     rcv = socket.socket(socket.PF_PACKET,socket.SOCK_RAW,socket.htons(0x1234))
#     rcv.bind(('eth0',s.getsockname()[1]))
# except Exception as e:
#     print('create rcv socket error')
...
def syn_scan_single(des_ip, des_port):
    ...
    try:
        ...
        pass
    timeout = 2  # test 3 times whether recevied the right packet
    ...
    if not pkt:
        ...
        return
    # unpack: 根据数据包的格式解包，依次为源目地MAC，上层类型，IP包，TCP包，FCS校验序列
    # data = struct.unpack("!6s6sH20s24s2s", pkt)
...
# syn_scan_single('172.19.61.33',9999)
# syn_scan_single('172.19.61.33',135)
# syn_scan_single('172.19.61.33',139)
# syn_scan_single('172.19.61.33',138)