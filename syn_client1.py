...
def syn_scan(des_ip,des_port):
    ...
    try:
        ...
        pass
    timeout = 3 # test 3 times whether recevied the right packet
...
syn_scan(iip,3389)
syn_scan(iip,445)
# syn_scan('172.19.61.33',9999)
# syn_scan('172.19.61.33',135)
# syn_scan('172.19.61.33',139)
# syn_scan('172.19.61.33',138)